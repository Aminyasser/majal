                    ...
                    <div class="col-lg-6">
                        <div class="login-sec">
                            <ul class="sign-control">
                                <li data-tab="tab-1" ><a href="#" title="">تسجيل الدخول</a></li>
                                <li data-tab="tab-2" class="current"><a href="#" title="">التسجيل</a></li>
                            </ul>
                                ...
                                <form method="POST" class="center-web" action="{{ route('login') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 no-pdd">
                                            <div class="sn-field">
                                                <input type="text" name="email" placeholder="Username Or email" @error('email') is-invalid @enderror" name="email"
